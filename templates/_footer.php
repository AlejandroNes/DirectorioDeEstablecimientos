<div id="footer" style="background-color: #2c3e50;">
	<div id="footer-inner">
		<div class="footer-inner-left" style="color: #b2bec3;">
			<?= $site_name; ?>
		</div>
		<div class="footer-inner-right">
			<ul>
				<?= show_menu('footer_menu', false); ?>
				<li><a style="color: #487eb0;" href="<?= $baseurl; ?>/_contact">Contacto</a>
			</ul>
		</div>
		<div class="clear"></div>
	</div>
...
// inserte html para usar el enlace de ubicación actual
