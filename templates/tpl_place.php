...
<style>
<?php
// estilos para el efecto de desenfoque de fondo que se muestra solo si este lugar tiene al menos una foto
if(!empty($blur_photo)) {
	?>
	#blur-photo {
			...
			<div id="review-form-wrapper">
				<form method="post" id="review-form">
					...
					<div class="form-row submit-row">
						<input type="button" id="submit-review" name="submit" value="Publicar" class="btn btn-blue btn-less-padding">
					</div>
				</form>
				<div class="clear"></div>
