				...
				<div class="login-form">
					<form id="the_form" method="post" action="<?= $baseurl; ?>/user/sign-up">
						...
						<div class="form-row">
							...
							<div class="alert-bubble" id="validate-password">Contraseña</div>
						</div>
