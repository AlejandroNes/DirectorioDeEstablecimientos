...
<ul >
	<li >
		<a style="background-color: #2c3e50; color: white;" href="<?= $baseurl; ?>/admin/" <?= ($home_active) ? 'class="active"' : ''; ?>>
	...
	<?php
	// escanear directorios de complementos, buscar menu.php dentro de cada carpeta de complementos
