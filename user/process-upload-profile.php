...
// solo permita el acceso a este archivo para los usuarios que hayan iniciado sesión
...
if($_FILES['userfile']['error'] != 0 || !exif_imagetype($_FILES['userfile']['tmp_name'])) {
	...
	// basename: devuelve el componente de nombre final de la ruta
	...
	if(@move_uploaded_file($_FILES['userfile']['tmp_name'], $path_tmp)) {
		...
		// primero elimine las fotos de perfil anteriores
