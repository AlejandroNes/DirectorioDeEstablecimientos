...
/*
Este archivo es solicitado por plugins / custom_fields / user-form-block.php a través de ajax
*/

$cat_id   = $_POST['cat_id'];
$place_id = $_POST['place_id'];

// busca campos globales y obtén solo los identificadores
// si se llama desde la página de edición del lugar, obtenga también los valores de campo
$query = "SELECT f.*
...
// encontrar campos para este gato
$custom_fields = array();
$query = "SELECT f.*
...
foreach($custom_fields as $v) {
	...
	// construir información sobre herramientas
	if(!empty($tooltip)) {
