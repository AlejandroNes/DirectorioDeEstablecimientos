...
// obtener los valores predeterminados de config.php
if(!isset($city_slug)) {
...
while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
	// restablecer $ Featured_listings array vars
	$feat_place_id               = '';
	$feat_place_name             = '';
	$feat_place_desc             = '';
	$feat_place_slug             = '';
	...
	// asignar vars del resultado de la consulta
