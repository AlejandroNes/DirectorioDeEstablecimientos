...
if($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
	...
	// detalles de la ciudad y el estado
	$query = "SELECT
...
// listados en el mismo vecindario
	...
	// anuncios en el mismo barrio y categoría
	...
	// almacenar todas las filas de consulta en una matriz (ver __test-hours.php)
	/*
	Array(
		[0] => Array(
				[day] => 1
	...
	*/
	...
	// ahora agrupe por día y cambie del día int al nombre del día
	/*
	Array(
		[mon] => Array(
				[0] => 1100-1300
